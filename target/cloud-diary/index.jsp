...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="font-size:25px" href="index?actionName=index">云日记</a>
        </div>

        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li <c:if test="${menu_page == 'index'}">class="active"</c:if>>
                    <a href="index?actionName=index">
                        <i class="glyphicon glyphicon-cloud"></i>&nbsp;主&nbsp;&nbsp;页
                    </a>
                </li>

                <li <c:if test="${menu_page == 'note'}">class="active" </c:if>>
                    <a href="note?actionName=view">
                        <i class="glyphicon glyphicon-pencil"></i>&nbsp;发表日记
                    </a>
                </li>

                <li <c:if test="${menu_page == 'type'}">class="active" </c:if>>
                    <a href="type?actionName=list">
                        <i class="glyphicon glyphicon-list"></i>&nbsp;类别管理
                    </a>
                </li>

                <li <c:if test="${menu_page == 'user'}">class="active"</c:if>>
                    <a href="user?actionName=userCenter">
                        <i class="glyphicon glyphicon-user"></i>&nbsp;个人中心
                    </a>
                </li>

                <li <c:if test="${menu_page == 'report'}">class="active"</c:if>>
                    <a href="report?actionName=info">
                        <i class="glyphicon glyphicon-signal"></i>&nbsp;数据报表
                    </a>
                </li>
            ...
            <form class="navbar-form navbar-right" role="search" action="index">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="搜索日记" value="${title}">
                </div>
...
<div class="container">
    ...
    <%--  类型列表  --%>
    <%--    <jsp:include page="type/list.jsp"/>--%>

    <%--  通过后台设置动态显示的页面，用过包含加载进来  --%>
